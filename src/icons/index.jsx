...
export function Carrinho({ onClick, qtd }) {
  ...
  return (
    <div className="container carrinho-container">
      {qtd ? <span className="qtd-carrinho">{qtd}</span> : null}
      <svg
        onClick={handleClick}
...
export function Lupa() {
  return (
    <svg
      ...
      strokeWidth={1.5}
      stroke="currentColor"
      className={`icon w-6 h-6 icon-lupa`}
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function SideBar({ onClick }) {
  ...
  return (
    <svg
      ...
      strokeWidth={1.5}
      stroke="currentColor"
      className={`icon w-6 h-6 hidden icon icon-sidebar`}
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function InstagramLogo() {
  return (
    <svg
      className="icon social-media icon-instagram"
      xmlns="http://www.w3.org/2000/svg"
      x="0px"
      y="0px"
      width="100"
...
export function LinkedInLogo() {
  return (
    <svg
      className="icon social-media icon-linkedin"
      xmlns="http://www.w3.org/2000/svg"
      x="0px"
      y="0px"
      width="100"
...
export function GithubLogo() {
  return (
    <svg
      className="icon social-media icon-github"
      xmlns="http://www.w3.org/2000/svg"
      x="0px"
      y="0px"
      width="100"
...
export function TiktokLogo() {
  return (
    <svg
      className="icon social-media icon-tiktok"
      xmlns="http://www.w3.org/2000/svg"
      x="0px"
      y="0px"
      width="100"
...
export function SuccessIcon({ onClick }) {
  ...
  return (
    <svg
      ...
      strokeWidth={1.5}
      stroke="currentColor"
      className="w-6 h-6 success-icon"
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
